...
def load_data():
    ...
    #####################################################################
    disstate = ['ASD', 'CD', 'CDI', 'nonCDI', 'CIRR', 'CRC', 'EDD', 'HIV',
        'MHE', 'NASH', 'OB',
        'PAR', 'PSA', 'RA', 'T1D', 'UC', 'H']
    ...
    # remove ow from dataset 
    # d_m = d_m[d_m['DiseaseState'] != 'OW']
    # d_m = d_m[d_m['DiseaseState'] != 'postFMT_CDI']

    d_m = d_m[d_m['DiseaseState'].isin(disstate)]
